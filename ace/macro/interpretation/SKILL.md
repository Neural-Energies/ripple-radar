...
1. Read [references/current-system.md](references/current-system.md). Re-check the files if the repo has moved. The live tree is `Neural-Energies/ripple-radar`. This file lives in `ace/macro/interpretation/`. Desk math is under `src/lib/live/`.
