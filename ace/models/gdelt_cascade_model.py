...
FIPS = {
    ...
    "NP": "Nepal", "NG": "Niger", "BU": "Bulgaria", "CE": "Sri Lanka",
    "MY": "Malaysia", "ID": "Indonesia", "BM": "Myanmar", "TH": "Thailand",
    "PP": "Papua New Guinea", "UG": "Uganda", "KE": "Kenya", "TZ": "Tanzania",
    "GV": "Guinea", "IV": "Ivory Coast", "SG": "Senegal", "CD": "Chad",
    "LY": "Libya", "AG": "Algeria", "MO": "Morocco", "TS": "Tunisia",
    "JO": "Jordan", "IZ": "Iraq", "SA": "Saudi Arabia", "AE": "UAE",
    "AM": "Armenia", "AJ": "Azerbaijan", "GG": "Georgia", "BO": "Belarus",
    "PL": "Poland", "RO": "Romania", "EN": "Estonia", "LG": "Latvia",
    "PE": "Peru", "EC": "Ecuador", "BL": "Bolivia", "AR": "Argentina",
    "CI": "Chile", "GT": "Guatemala", "HO": "Honduras", "NU": "Nicaragua",
